...
import RaceHorseOverlapPedigree from 'src/components/RaceHorseOverlapPedigree';
...
function PedigreeOverlap(props: any) {   
   ...
   React.useEffect(() => {
      ...
      setGenerationsArray(props.hypomatingOverlapData?.raceHorse?.pedigree);
      setHypomatingStallionHorsePic(profilePic);    
   }, [props.hypomatingOverlapData?.raceHorse])
   ...
   }, [props.hypomatingOverlapData?.stakeWinner])
                  ...
                  <Grid container spacing={0} className='middayPredegreeWrp'>
                     <Grid item xs={12} md={6} lg={6}>
                        <Box className='pedegree-overlap-left-wrapper'>
                           ...
                           {props.hypomatingOverlapData?.raceHorse && <RaceHorseOverlapPedigree
                              type="stallion"
                              hypomatingOverlapData={generationsArray}
                              pedigreeTreeLevel={props.hypomatingOverlapData.raceHorse.pedigreeTreeLevel}
                              data={props.hypomatingOverlapData.raceHorse}
                     ...
                     <Grid item xs={12} md={6} lg={6}>
                        <Box className='pedegree-overlap-right-wrapper'>
                           ...
                           {props.hypomatingOverlapData.stakeWinner && <RaceHorseOverlapPedigree
                              type="swHorse"
