...
import { useRaceHorseStakesWinnersComparisionQuery } from 'src/redux/splitEndpoints/raceHorseSplit';
...
function StakesWinnersComparision() {
  ...
  const { data: SWCData, isSuccess, isLoading } = useRaceHorseStakesWinnersComparisionQuery(params, {skip : !isHorseParam});
