...
function Pedigree(props: any) {
  type filtersType = typeof common;
  const placeholderType: filtersType = common;
  const placeholderArr = [
    placeholderType.common.sire,
    placeholderType.common.damSire,
    placeholderType.common.keyAncestor,
  ];
  ...
  return (
    <div>
      {placeholderArr.map((placeholder: string) => (
        <div key={placeholder}>
          <PedigreeAutocomplete
            placeholder={placeholder}
            {...props}
            ref={getSpecificRef(placeholder)}
          />
        </div>
      ))}
