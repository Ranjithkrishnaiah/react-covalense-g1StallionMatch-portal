...
function HypoMatingStallionPagePedigree({
  stallionId,
  isStallionParam,
  mareId,
  isMareParam,
  ...
  React.useEffect(() => {
    if (isMareSuccess || isHypomatingData) {
      profilePic = Images.HorseProfile;
            ...
            <Box sx={{ flexGrow: 1, width: '100%', margin: '0 auto' }} className='SPtreechatBody'>
              <Stack direction='row'>
                ...
                {isStallionParam && <Box flexGrow={1} className='pedegreeLogo'>                    
                    <Box className='pedegreeLogoImg'>
                        {data?.farmLogo === null ?
                        <img key={1} src={Images.farmplaceholder} alt={data?.farmName} />
                        :
                        <Imgix
                            ...
                            <Box style={{ width: '100%' }} key={subindex} className='treeCell'>
                              ...
                              >
                                ...
                                <Box className='PredegreeWhiteBoxText'>
                                  ...
                                  >
                                    <Typography variant='h5' className={pedigree.ColorCoding} aria-describedby={pedigree.horseId} id={pedigree.horseId} onClick={() => {(index > 0) ? void(0) : handlePedigree((isStallionParam) ? stallionId : mareId, (isStallionParam) ? 'stallion' : 'mare', stallionFarmCount)}}>
...
export default HypoMatingStallionPagePedigree;