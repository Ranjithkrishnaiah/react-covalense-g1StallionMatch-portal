            ...
            <Box className='accordion-wrapper-st-search perfect-match-accordion-wrapper' mb={4}>
               <Accordion defaultExpanded={true}>
                  <AccordionSummary
                     ...
                     id="panel1a-header"
                  >
                     <Typography variant='h5'> <i className='icon-Fire icon-for-alternate' /> Perfect Match!</Typography>
                  </AccordionSummary>
                  <AccordionDetails>
                     <Typography>
                        A Perfect Match occurs when there are 2 or more Graded Stakes Winners with common ancestors in every quarter of the pedigree of your mating. Of all Stallion Match searches, only 3 in 100 are a Perfect Match.
                     </Typography>
                     <CustomButton type="button" className='accordionBtnT20' disabled={disabledT20Button} onClick={handleMessageNavigation}>Contact {toPascalCase(props?.data?.stallionFarmLogo?.farmName)} about this mating <i className='icon-Arrow-right' /></CustomButton>
