...
type PedigreeProps = {
 ...
 function RaceHorseOverlapPedigree({
   type,
   ...
   let highestPedigreeLevel = Math.max(...allIndexArray);
    ...
    return (
      ...
      <Box sx={ { flexGrow: 1, width: '100%', margin: '0 auto' } } className='SPtreechatBody RaceSPtreechatBody'>    
         <Stack direction='row'>
         { isStallionParam && <Box flexGrow={1} className='pedegreeLogo'>
         <Box className='RacepedegreeLogoImg'>
            {/* <img src={stallionFarmLogo} alt={stallionFarmName ? stallionFarmName +' Logo' : ''}/> */}
            </Box></Box> }
         ...
         >     
         <Grid 
            className={"PredegreeWrapperBoxInner RacePredegreeWrapperBoxInner"
 ...
 export default RaceHorseOverlapPedigree;