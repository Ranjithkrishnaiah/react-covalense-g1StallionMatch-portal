...
function CustomDropzoneMedia(dataProps: any) {
  ...
  const onDrop = useCallback((acceptedFiles) => {
    ...
    const fileSize = 10000000; //53983 bites 5MB chnaged to 10MB limit
  ...
  if (fileSelected) {
    ...
    imageFile = imageFormats.includes(type) ? <img src={props.fileDetails?.mediaUrl} alt={props.fileDetails?.fileName} /> : '';
...
export default CustomDropzoneMedia;
