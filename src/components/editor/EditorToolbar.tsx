...
export default function EditorToolbar({ id, isSimple, ...other }: EditorToolbarProps) {
  return (
    <EditorToolbarStyle className="editor-box-white" {...other}>
      <div id={id}>
        ...
        <div className="ql-formats ql-formats-link">
          <button type="button" className="ql-image" />
          <button type="button" className="ql-link octicon octicon-link" />
        ...
        {!isSimple && (
          <div className="ql-formats ql-formats-undo">
